...
module.exports = (function () {
  ...
  var PreProcessor = function (fileLines) {
  ...
  PreProcessor.prototype.getClasses = function () {
    return this.aClasses;
  }

  PreProcessor.prototype.getItems = function () {
    return this.aItems;
  }

  PreProcessor.prototype.setupConnections = function () {
    for (var i = 0, length = this.aConnections.length; i < length; i++) {
      this.setupConnection(this.aConnections[i]);
    }
  }

  PreProcessor.prototype.setupConnection = function (connection) {
    var cLeft = null;
    var cRight = null;
  ...
  PreProcessor.prototype.populateGlobals = function (item) {
